...
export default function IdeaFactoryCaseStudy() {
  const metadata: Metadata = createPageMetadata({
    title: "Idea Factory Case Study",
    description:
      "A behind-the-scenes look at how Codex Studio’s MVE emerged from Startup Virginia’s Idea Factory program.",
    path: "/idea-factory",
  });
  return (
    <>
          ...
          <main className="mx-auto flex max-w-4xl flex-col gap-10 px-4 py-10 md:px-6 md:py-14">
            ...
            >
              ...
              <p className="max-w-2xl text-sm text-neutral-300">
                The focus was on{" "}
                <span className="text-neutral-100">
                  people and organizations who need to preserve, present, or
                  share real-world knowledge and experiences digitally
                </span>{" "}
            ...
            <section className="space-y-3 border-t border-neutral-900 pt-8">
              ...
              <ol className="ml-5 list-decimal space-y-2 text-sm text-neutral-300">
                <li>
                  ...
                  – simplify capture, production, and publishing so it&apos;s
                  not &quot;too difficult,&quot; &quot;too slow,&quot; or
                  &quot;too confusing.&quot;
                </li>
                <li>
                  <span className="font-semibold text-neutral-100">
                  ...
                  – provide ways to experiment with 3D/AR that work across
                  devices and skill levels, without feeling &quot;too
                  expensive&quot; or &quot;too uncomfortable.&quot;
                </li>
                <li>
                  <span className="font-semibold text-neutral-100">
                  ...
                  access, engagement, and educational impact so efforts
                  don&apos;t feel &quot;too confusing&quot; or &quot;too
                  wasteful.&quot;
                </li>
              </ol>
            </section>
            ...
            <section className="space-y-3 border-t border-neutral-900 pt-8">
              ...
              <p className="text-sm text-neutral-300">
                ...
                enterprise teams. The technology is powerful—but most teams
                never make it past interest and experimentation because the{" "}
                <span className="text-neutral-100">
                  tooling, workflows, and staffing requirements are too heavy.
                </span>
              </p>
              <p className="text-sm text-neutral-300">
                Going into Idea Factory, my hypothesis was that a lot of these
                pains are symptoms of the same core gaps:
              </p>
            ...
            <section className="space-y-3 border-t border-neutral-900 pt-8">
              ...
              <p className="text-sm text-neutral-300">
                Over the course of the program, I spoke with and surveyed a mix
                of:
              </p>
              <ul className="ml-5 list-disc space-y-1 text-sm text-neutral-300">
                <li>
              ...
              <p className="text-sm text-neutral-300">
                I used a Jobs-to-be-Done framing—&quot;When you try to capture
                or publish 3D/AR content…&quot;—to surface real jobs, pains, and
              ...
              <div className="space-y-4 text-sm text-neutral-300">
                <div>
                  <h3 className="text-sm font-semibold text-neutral-100">
                    1. Teams want a unified workflow, not more disconnected
                    tools.
                  </h3>
                  <p>
                    Most respondents described their current approach as a
                    patchwork of capture apps, 3D tools, and file-sharing links.
                ...
                <div>
                  <h3 className="text-sm font-semibold text-neutral-100">
                    2. “We don&apos;t have a 3D person” is the most common
                    blocker.
                  </h3>
                  <p>
                    ...
                    stops projects before they begin. Capture, cleanup,
                    topology, and file prep are perceived as highly specialized
                    skills. This validates the opportunity for{" "}
                    <span className="text-neutral-100">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-neutral-100">
                    3. People don&apos;t want files—they want ready-to-use
                    outputs.
                  </h3>
                  <p>
                    When asked what success looks like, respondents rarely said
                    &quot;a mesh&quot; or &quot;a USDZ.&quot; They said things
                    like
                    <span className="text-neutral-100">
                      {" "}
                      &quot;something I can embed in my LMS,&quot; &quot;a 3D
                      view on a product page,&quot; or &quot;a link my students
                      can spin around.&quot;
                    </span>{" "}
                ...
                <div>
                  <h3 className="text-sm font-semibold text-neutral-100">
                    5. Static 3D isn&apos;t enough—people want interpretation
                    and context.
                  </h3>
                  <p>
                    Particularly in museums and education, stakeholders
                    emphasized that a 3D model on its own felt underwhelming.
                    They wanted{" "}
                    <span className="text-neutral-100">
                      labels, guided tours, comparisons, narration, and
                      multi-modal storytelling
                    </span>{" "}
                    to make the effort worthwhile. This aligns squarely with the
                    opportunity to use storytelling and interactive media to
            ...
            <section className="space-y-3 border-t border-neutral-900 pt-8">
              ...
              <p className="text-sm text-neutral-300">
                These opportunities and findings directly informed the first
                version of Codex3D you see on this site:
              </p>
              <ul className="ml-5 list-disc space-y-2 text-sm text-neutral-300">
                <li>
                  <span className="font-semibold text-neutral-100">
                    Unified &quot;upload → 3D → publish&quot; flow (Opportunity
                    #1)
                  </span>{" "}
                  – the MVE focuses on a single, simple path: upload images,
                  choose a mode, receive a 3D output plus a future embed
                  snippet.
                </li>
                <li>
                  <span className="font-semibold text-neutral-100">
                    Multiple modes mapped to skill level & fidelity (Opportunity
                    #1 & #2)
                  </span>{" "}
                  – AI Fast, Photogrammetry, Gaussian Splats, and Pro Processing
                  let different users pick the balance of speed, quality, and
                  budget that fits their situation.
                </li>
                <li>
                  <span className="font-semibold text-neutral-100">
                  ...
                  experience accessible while I validate demand before investing
                  in heavy automation.
                </li>
                <li>
                  <span className="font-semibold text-neutral-100">
                  ...
                  – the roadmap explicitly includes hotspots, annotations,
                  guided tours, and integration with Codex Learn / Codex Present
                  so that assets don&apos;t live in isolation.
                </li>
              </ul>
            </section>
            ...
            <section className="space-y-3 border-t border-neutral-900 pt-8">
              ...
              <ul className="ml-5 list-disc space-y-2 text-sm text-neutral-300">
                <li>
                  For Opportunity #1: Do users feel like the Codex3D flow
                  actually simplifies capture → production → publishing, or
                  where does it still feel &quot;too difficult&quot; or
                  &quot;too slow&quot;?
                </li>
                <li>
                  For Opportunity #2: Which modes do different segments
                  gravitate toward, and what does that say about how
                  &quot;lightweight&quot; or &quot;affordable&quot; this needs
                  to be?
                </li>
                <li>
                  For Opportunity #3: When people talk about success, do they
                  ask for more narrative, interactive, or educational layers on
                  top of the 3D outputs?
                </li>
              </ul>
            </section>
            ...
            <section className="space-y-3 border-t border-neutral-900 pt-8 pb-10">
              ...
              <p className="mt-2 text-sm text-neutral-400">
                ...
                accessible workflow that turns real-world objects and knowledge
                into meaningful, story-driven digital experiences. Codex3D is
                the first concrete step in that direction.
              </p>
            </section>
            <BackToTop />
          </main>
